...
const breweryPrompts = {
  getBeerCount() {
    ...
    const result = breweries.reduce((acc, curBrewery) => {
      acc += curBrewery.beers.length;
      return acc;
    }, 0);
    return result;
  ...
  getBreweryBeerCount() {
    ...
    const result = breweries.reduce((acc, curBrewery) => {
      ...
      let obj = { name : curBrewery.name, beerCount: curBrewery.beers.length};
  ...
  findHighestAbvBeer() {
    let highestAbvBeer = breweries[0].beers[0];
